...
"""
	The parameters for extFeatures is as follow:
		(row, opacity, group)
		Row: The row to extract the features
		Opacity: The grayscale value (0-255) that we want to consider in the calculation
		group: The number of divisions (subgroups) 
"""
